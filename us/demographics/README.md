...
* `medical_conditions.csv`: county wise prevalence of five underlying medical conditions associated with increased risk for severe COVID-19–associated illness (chronic obstructive pulmonary disease, heart disease, diabetes, chronic kidney disease, and obesity)
